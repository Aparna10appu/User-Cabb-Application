...
public class LoginBL {
	...
	public String validateUser(@RequestBody EmployeeBO employeeBo, HttpServletRequest request, HttpServletResponse response) throws ExecutionException, InterruptedException, MalformedURLException {
		String jwt = null;
	...
	private Future<AuthenticationResult> azureValidation(String mail, String password) throws MalformedURLException, InterruptedException, ExecutionException, AuthenticationException {
